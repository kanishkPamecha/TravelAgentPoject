...
function App() {
  ...
  return (
    ...
    {/* User */}
           {/* HomePage  */}
               {isMobile ? 
                  <Route path="/" element={[<Navbar activeTab={"Home"} />, <YourComponent userEmail={userEmail} /> , <Packages1 />, <Home />, <Prepaid />]} />
              //  <Route path="/" element={[<Navbar activeTab={"Home"} />, <YourComponent userEmail={userEmail} />, <Home />, <Packages1 />, <Prepaid />]} /> 
              :
                <Route path="/" element={[<Navbar activeTab={"Home"} />, <YourComponent userEmail={userEmail} /> , <Packages1 />, <Home />, <Prepaid />]} />}
      {/*  ,<Slider /> */}
      {/* Train Page   */}
